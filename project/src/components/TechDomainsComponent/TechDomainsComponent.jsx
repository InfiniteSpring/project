                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/process-automation/workflow-automation">
                                        <img src={icon1} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/process-automation/business-process-automation">
                                        <img src={icon2} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/process-automation/document-data-extraction-processing">
                                        <img src={icon3} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/process-automation/virtual-assistance-support">
                                        <img src={icon4} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/artificial-intelligence/ai-for-business">
                                        <img src={icon13} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/artificial-intelligence/machine-learning">
                                        <img src={icon22} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/artificial-intelligence/deep-learning">
                                        <img src={icon12} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                                        <h4>Deep learning</h4>
                                    </a>
                                </div>
                                <div className="option-underline"></div>
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/artificial-intelligence/computer-vision">
                                        <img src={icon23} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/artificial-intelligence/reinforcement-learning">
                                        <img src={icon18} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/big-data/data-warehouse">
                                        <img src={icon19} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/big-data/data-lake">
                                        <img src={icon20} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                                        <h4>Data lake</h4>
                                    </a>
                                </div>
                                <div className="option-underline"></div>
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/big-data/big-data-analytics">
                                        <img src={icon10} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/big-data/business-intelligence">
                                        <img src={icon21} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                        ...
                        <div className="options-container">
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/blockchain/cryptocurrency">
                                        <img src={icon11} style={{ width: "7dvh", height: "7dvh" }} alt="" />    
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    ...
                                    <   img src={icon6} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/blockchain/smart-contracts">
                                        <img src={icon7} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/cloud-computing/cloud-computing-for-business">
                                        <img src={icon5} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/cloud-computing/virtualization">
                                        <img src={icon8} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/cyber-security/encryption">
                                        <img src={icon17} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                                        <h4>Encryption</h4>
                                    </a>
                                </div>
                                <div className="option-underline"></div>
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/cyber-security/firewalls">
                                        <img src={icon14} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                                        <h4>Firewalls</h4>
                                    </a>
                                </div>
                                <div className="option-underline"></div>
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/cyber-security/malware">
                                        <img src={icon16} style={{ width: "7dvh", height: "7dvh" }} alt="" />
                                        <h4>Malware</h4>
                                    </a>
                                </div>
                                <div className="option-underline"></div>
                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/cyber-security/network-security">
                                        <img src={icon15} style={{ width: "7dvh", height: "7dvh" }} alt="" />
