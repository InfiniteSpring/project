                            ...
                            <div className="option">
                                <div className="option-btn">
                                    <a href="/web-development/fronend">
                                        <h4>Frontend</h4>
                                        <span>Tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniamt esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span>
                                    </a>
                                </div>
                            </div>
                            <div className="option">
